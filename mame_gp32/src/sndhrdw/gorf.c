...
/* Phoneme to word translation */
	 ...
	 if (strlen(totalword) == 0) {
		 gm_strcpy(totalword,PhonemeTable[Phoneme]);	                   /* Copy over the first phoneme */
		 if (plural != 0) {
		 ...
		 gm_strcat(totalword,PhonemeTable[Phoneme]);	                   /* Copy over the first phoneme */
