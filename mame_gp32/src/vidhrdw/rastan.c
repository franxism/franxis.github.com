...
int rastan_vh_start (void)
{
	...
	rastan_dirty1 = gm_zi_malloc ( rastan_videoram_size/4);
	if (!rastan_dirty1)
	{
		rastan_vh_stop();
		return 1;
	}
	gm_memset(rastan_dirty1,1,rastan_videoram_size / 4);

	rastan_dirty3 = gm_zi_malloc ( rastan_videoram_size/4);
	if (!rastan_dirty3)
	{
		rastan_vh_stop();
		return 1;
	}
	gm_memset(rastan_dirty3,1,rastan_videoram_size / 4);
...
void rastan_vh_stop (void)
{
	...
	/* Free video RAM */
	if (rastan_dirty1)
	        gm_free (rastan_dirty1);
	if (rastan_dirty3)
	        gm_free (rastan_dirty3);
