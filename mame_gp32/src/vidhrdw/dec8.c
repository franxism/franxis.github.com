...
int dec8_vh_start (void)
{
	...
	palette_ram=gm_zi_malloc(0x800);
	pf_video=gm_zi_malloc(0x1000);
	pf_dirty=gm_zi_malloc(0x800);
	oscar_shared_mem=gm_zi_malloc(0x2000);    
	gm_memset(pf_dirty,1,0x800);
	return 0;
}
