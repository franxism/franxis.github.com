...
{
	if ((bg_dirtybuffer = gm_zi_malloc (speedbal_background_videoram_size)) == 0)
	{
		return 1;
	}
	if ((ch_dirtybuffer = gm_zi_malloc (speedbal_foreground_videoram_size)) == 0)
	{
	...
	gm_memset (ch_dirtybuffer,1,speedbal_foreground_videoram_size / 2);
	gm_memset (bg_dirtybuffer,1,speedbal_background_videoram_size / 2);
	return 0;
