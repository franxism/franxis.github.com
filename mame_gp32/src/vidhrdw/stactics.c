...
int stactics_vh_start(void)
{
    ...
    gm_memset(dirty_videoram_b,1,sizeof(dirty_videoram_b));
    gm_memset(dirty_chardata_b,1,sizeof(dirty_chardata_b));
    gm_memset(dirty_videoram_d,1,sizeof(dirty_videoram_d));
    gm_memset(dirty_chardata_d,1,sizeof(dirty_chardata_d));
    gm_memset(dirty_videoram_e,1,sizeof(dirty_videoram_e));
    gm_memset(dirty_chardata_e,1,sizeof(dirty_chardata_e));
    gm_memset(dirty_videoram_f,1,sizeof(dirty_videoram_f));
    gm_memset(dirty_chardata_f,1,sizeof(dirty_chardata_f));
    ...
    gm_memset(firechar,0,sizeof(firechar));
    for(i=0;i<256;i++)
    {
        for(j=0;j<8;j++)
        {
